...
//./bin/kafka-topics.sh --zookeeper localhost:2181 --create --topic persons --replication-factor 1 --partitions 4
//below code will produce message in this queue
//./bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic persons
